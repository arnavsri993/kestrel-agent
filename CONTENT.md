# Workstrand desktop content lock

## Workstrand daily-work entry

### Product promise

- Workstrand is the one place to bring a project or question, from first inspection through verified delivery.
...
- Project access is explicit and revocable. Workstrand can work only inside folders the user grants.
...
1. Choose or grant the project Workstrand may work in.
...
- New-task support: “Bring a project or a question. Workstrand can inspect, build, research, run, and verify the work.”
- Project label: “Project”
- No-project option: “No project — conversation only”
- Project grant action: “Add project”
- Composer label: “Message Workstrand”
- Composer placeholder: “What do you want to get done?”
- Automatic route: “Automatic — Workstrand chooses”
...
- Workstrand is a local-first personal agent.
...
- New-task support: “Ask normally. Workstrand will bring in relevant local context when it can help.”
- Composer label: “Message Workstrand”
- Composer placeholder: “Ask Workstrand to help with anything”
- Background pending state: “1 approval waiting” / “Workstrand prepared a plan and paused before acting”
...
- Loading: “Starting Workstrand…”
- Core error: “Workstrand could not start.” / “Try again”
- Response loading: “Checking relevant device context…”
- Response error: “Workstrand could not finish that response. Your message is still here—try again when the local core is available.”
