...
- Type pair: preserve native New York/ui-serif for decisive page headlines and the Kestrel name; macOS system sans for explanatory copy and controls; SFMono only for model IDs, sizes, and provider evidence.
