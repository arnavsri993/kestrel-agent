...
Workstrand is a local-first Electron application with a separately built static website. The product runtime and marketing runtime never share privileged code.
