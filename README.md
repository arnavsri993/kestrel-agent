...
- Outreach provides an encrypted, draft-first contact and message workspace for application follow-up, business outreach, and recruiting. Contacts and drafts remain local until reviewed; external sending requires a fresh one-time approval and connector verification. See [outreach and application workflow](docs/outreach-and-application-workflow.md) and [application-form provider evaluation](docs/application-form-provider-evaluation.md).
