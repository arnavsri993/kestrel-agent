	...
	async providerEnvironment(
		...
		const environment: NodeJS.ProcessEnv = {
			...
			...(base.KESTREL_OPENCODE_SUBSCRIPTION_MODEL
				...
				: {}),
			...(base.KESTREL_ENABLE_CURSOR_SUBSCRIPTION
				? {
						KESTREL_ENABLE_CURSOR_SUBSCRIPTION:
							base.KESTREL_ENABLE_CURSOR_SUBSCRIPTION,
					}
				: {}),
			...(base.KESTREL_CURSOR_PATH
				? { KESTREL_CURSOR_PATH: base.KESTREL_CURSOR_PATH }
				: {}),
			...(base.KESTREL_CURSOR_SUBSCRIPTION_MODEL
				? {
						KESTREL_CURSOR_SUBSCRIPTION_MODEL:
							base.KESTREL_CURSOR_SUBSCRIPTION_MODEL,
					}
				: {}),
