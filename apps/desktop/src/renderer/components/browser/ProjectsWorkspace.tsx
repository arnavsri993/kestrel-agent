  ...
  return (
    ...
    >
      <PageFrame
        as="div"
        title="Projects"
        titleId="projects-workspace-title"
        description="Keep related chats together with the local context they share."
        measure="wide"
      >
        {projects.length > 0 && selectedProject ? (
          <div className="projects-workspace-layout">
            <nav className="projects-workspace-directory" aria-label="Projects">
            ...
            >
              <header className="projects-workspace-detail-header">
                <div>
                  ...
                  <p>
                    Each chat keeps its own transcript while sharing this
                    project&apos;s local folder context.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="projects-workspace-context">
                <Icon
                  name={
                    selectedProject.available === false ? "warning" : "folder"
                  }
                />
                <span>
                  <strong>
          ...
          <section className="projects-workspace-empty projects-workspace-no-projects">
            ...
            <p>
              Add a local project folder to keep related chats and their shared
              context together.
            </p>
            <button
              type="button"
