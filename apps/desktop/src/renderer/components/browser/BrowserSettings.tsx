		...
		<section className="settings-stack browser-settings-panel">
			...
			<div className="setting-row browser-setting-row">
				<div className="browser-setting-copy">
					...
					<small>
						History stays on this Mac and is searched only when needed.
					</small>
				</div>
				<select
			...
			<div className="setting-row browser-setting-row">
				<div className="browser-setting-copy">
					...
					<small>
						Open tabs, downloads, cookies, and site data are not removed.
					</small>
				</div>
				<button
					type="button"
			...
			<p className="browser-security-note">
				User tabs use a persistent browser profile. Autonomous agent browsing
				remains isolated and does not share these cookies or site storage.
			</p>
		</section>
	);
}
