...
export const metadata: Metadata = {
  ...
  description: "How the Kestrel local work agent handles projects, credentials, model traffic, paired devices, diagnostics, and deletion."
};
...
const sections = [
  ...
  },
  {
    ...
    paragraphs: ["Data leaves the device only when a feature needs a service you selected. The destination and purpose depend on that connection."],
    items: [
