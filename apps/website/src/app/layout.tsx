...
const socialImageUrl = new URL(sitePath("/media/social-preview.svg"), siteUrl.origin);
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Kestrel — one place for the whole job",
    description: "Bring a project or a question. Kestrel can inspect, build, research, run, and verify the work with visible approval boundaries.",
    images: [{ url: socialImageUrl, width: 1200, height: 630, alt: "Kestrel local work agent" }]
  }
};
