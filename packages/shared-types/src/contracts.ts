...
export type DashboardMetricSource = z.infer<
  typeof DashboardMetricSourceSchema
>;
...
export const DashboardContributionSchema = z
  ...
  .strict();
export type DashboardContribution = z.infer<
...
export const EventApplicationSchema = z.object({
  ...
  deadline: z.string().datetime().optional(),
  status: z.enum(["draft", "preparing", "ready", "approved", "submitted", "needs_attention"]),
...
export const CoreRequestSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    id: z.string().regex(/^event-application-[a-f0-9-]{36}$/),
    status: z.enum(["draft", "preparing", "ready", "approved", "needs_attention"]).optional(),
