...
function generationLimit(value: number | undefined): number {
	...
	if (
		...
		value < 1 ||
		value > MAX_GENERATED_ARTIFACT_BYTES
	)
		throw new Error("Generated artifact byte limit is invalid.");
	return value;
}
...
export class ArtifactManager {
	...
	createWidget(input: {
		...
		const evicted =
			scoped.length >= 32 ? scoped.slice(0, scoped.length - 31) : [];
...
function registerMediaListTool(
...
function registerMediaInspectTool(
	runtime: AgentRuntime,
	manager: ArtifactManager,
	sessionId: string,
): void {
...
function registerMediaGenerateTool(
	runtime: AgentRuntime,
	manager: ArtifactManager,
	sessionId: string,
): void {
...
function registerMusicGenerateTool(
	runtime: AgentRuntime,
	manager: ArtifactManager,
	sessionId: string,
): void {
...
function registerShowWidgetTool(
	runtime: AgentRuntime,
	manager: ArtifactManager,
	sessionId: string,
): void {
